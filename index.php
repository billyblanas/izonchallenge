<?php
		...
		//include_once dirname(__FILE__).'/../../init.php';		Hackademic CMS
        session_start();
        ...
        //require_once(HACKADEMIC_PATH."pages/challenge_monitor.php"); - Hackademic CMS
		...
		*/
		if (isset($_GET['user']) && !(isset($_SESSION['init_timer']))) {
			//$monitor->update(CHALLENGE_INIT,$_GET['user'],$_GET['id'],$_GET['token']); - Hackademic CMS
...
if ($_SESSION['ch04'] == 1) {
			...
			//$monitor->update(CHALLENGE_SUCCESS); - Hackademic CMS
		}
?>
<script>
